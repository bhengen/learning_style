    ...
    <body>
        ...
        <div id="container">
            ...
            <table id='record-list-table'>
                ...
                <?php
                        echo "
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[teacher_id]' name='teacher_id'></td>
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[first_name]' name='first_name'></td>
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[last_name]' name='last_name'></td>
                            ...
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[school_name]' name='school_name'></td>
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[city]' name='city'></td>
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[state]' name='state'></td>
                            <td class='edit-list-data'><input class='edit-input' type='text' value='$row[postal_code]' name='postal_code'></td>
